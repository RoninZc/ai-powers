---
description: 使用 Agent Browser/Playwright 生成并运行端到端测试。创建测试旅程、运行测试、捕获截图/视频/跟踪，并上传工件。
---

# E2E 命令

此命令调用 **e2e-runner** 代理来使用 Agent Browser/Agent Browser 生成、维护和执行端到端测试。

## 此命令的作用

1. **生成测试旅程** - 为用户流程创建 Agent Browser 测试
